    ...
    <div class="row" style="margin: 0px 50px 0px 50px">
      <div class="col-md-6 col-md-push-3">
        ...
        <form role="form" method="post" action="post-data.php" id="contactform">
          <fieldset>
            <legend>ADD your movie data</legend>
            ...
            <div class="actions">
              <input type="submit" value="(+Add)" name="submitData" id="submitButton" class="btn btn-primary" title="" />
              <input type="submit" value="Delete Movie" name="deleteMovie" id="submitButton" class="btn btn-danger" title="" />
              <input type="submit" value="Delete All Movies" name="deleteAllMovies" id="submitButton" class="btn btn-danger" title="" />
              <input type="submit" value="Update Movie" name="update" id="submitButton" class="btn btn-info" title="" />
            </div>
          </fieldset>
        </form>
      ...
      <div class="col-md-6 col-md-push-3">
        <form role="form" method="post" action="delete-data.php" id="contactform">
          <fieldset>
